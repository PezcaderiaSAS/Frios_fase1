...
function instalarSistema() {
  ...
  const esquema = {
    ...
    'DIM_CONTRATOS': ['ID_CONTRATO', 'ID_CLIENTE', 'POSICIONES_CONTRATADAS', 'FACTOR_POSICION', 'PRECIO_POSICION', 'PRECIO_DIA_EXCESO', 'FECHA_INICIO', 'ESTADO'],
    'DIM_PRODUCTOS': ['ID_PRODUCTO', 'NOMBRE', 'PESO_NOMINAL_CAJA', 'TIPO_EMPAQUE'], // Ej: Caja, Canastilla
